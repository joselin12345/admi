                        ...
                        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                <div class="dropdown-list-image mr-3">
                                    <img class="rounded-circle" src="resursos/img/undraw_profile_1.svg"
                                         alt=".">
                    ...
                    <div class="col-xl-4 col-lg-4">
                        ...
                        <div class="card shadow mb-4 border-left-primary">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary"><%=j.getNombreJuegos()%></h6>
                            </div>
                            <div class="card-body text-center">
                                <img src="<%=j.getImagen().getDireccionArchivo()%>" alt="Imagen" class="img-fluid">
                    ...
                    <div class="col-xl-8 col-lg-8">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-justify"> <%=j.getDescripcion()%></p>
                                <div class="d-flex align-items-center mb-3">
                                    <h6 class="mr-3">Consola: PlayStation </h6>
                                    <div class="row">
                                        <div class="col-sm-1">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <div class="d-flex">
                                        <button class="btn">Precio: <%=j.getPrecio()%></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-xl-auto mb-3">
                            <div class="d-flex justify-content-between">
                                <a href="<%=request.getContextPath()%>/AdminServlet?action=listaPaginaOfertas" class="btn btn-primary">Guardar</a>
                            </div>
                        </div>
                    </div>
                </div>
