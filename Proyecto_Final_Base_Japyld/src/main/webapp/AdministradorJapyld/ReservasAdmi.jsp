      ...
      <div class="container-xl px-4 mt-4">
        ...
        <div class="row">
          <div class="col-xl-6">
            ...
            <div class="card mb-4 mb-xl-0">
              ...
              <div class="card-header font-weight-bold text-primary">RESERVAS CON MAS DE 30 DIAS</div>
        ...
        <div class="col-xl-12">
          ...
          <div class="card mb-4 mb-xl-0">
            ...
            <div class="card-header font-weight-bold text-primary">RESERVAS CON MENOS DE 10 DIAS</div>
            <div class="card-body text">
